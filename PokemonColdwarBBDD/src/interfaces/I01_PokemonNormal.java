...
public class I01_PokemonNormal extends I00_Pokemon{

	// contructor que hereda de la clase Planeta

	public I01_PokemonNormal(String nombreEquipo, int tipoPlaneta) {

		super(nombreEquipo, 200, 50, tipoPlaneta);

	}
	
	public I01_PokemonNormal (String nombreEquipo, int tipoPlaneta, int vidas, int misilesRonda) {
