...
public class C10A_CombateAtacar extends JPanel implements ActionListener {
	...
	public C10A_CombateAtacar(){
		...
		if (C01_Principal.pokemon.size()==8) {
			...
			if (C09_Combate.turno == 0) {
			...
			else if (C09_Combate.turno == 1) {

				cb2 = checkBoxGeneral(143, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-8).getNombreEquipo()), cb2);
			...
			else if (C09_Combate.turno == 2) {

				cb2 = checkBoxGeneral(143, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-8).getNombreEquipo()), cb2);

				cb3 = checkBoxGeneral(199, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-7).getNombreEquipo()), cb3);
			...
			else if (C09_Combate.turno == 3) {

				cb2 = checkBoxGeneral(143, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-8).getNombreEquipo()), cb2);

				cb3 = checkBoxGeneral(199, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-7).getNombreEquipo()), cb3);

				cb4 = checkBoxGeneral(255, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-6).getNombreEquipo()), cb4);
				...
				cb5 = checkBoxGeneral(311, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-5).getNombreEquipo()), cb5);
				...
				cb6 = checkBoxGeneral(367, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-4).getNombreEquipo()), cb6);
				...
				cb7 = checkBoxGeneral(423, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-3).getNombreEquipo()), cb7);

				cb8 = checkBoxGeneral(479, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-1).getNombreEquipo()), cb8);

			}

			else if (C09_Combate.turno == 7) {
				...
				cb8 = checkBoxGeneral(479, (C01_Principal.pokemon.get(C01_Principal.pokemon.size()-2).getNombreEquipo()), cb8);
		...
		if (jtPP.getText().isEmpty() || Integer.parseInt(jtPP.getText()) > C01_Principal.pokemon.get(C09_Combate.turno).getMisilesRonda()) {
				...
				for (int i=0; i<C01_Principal.pokemon.size(); i++) {
					...
					if (cb8.getText().equals(C01_Principal.pokemon.get(i).getNombreEquipo())) {
						...
						if (C01_Principal.pokemon.get(i).getTipoPlaneta()==6) {
							...
							C09_Combate.resumen += C01_Principal.pokemon.get(C09_Combate.turno).getNombreEquipo()+" ATACÓ a "+C01_Principal.pokemon.get(i).getNombreEquipo()+ " con "+jtPP.getText() + " PP\n     y "+ C01_Principal.pokemon.get(i).getNombreEquipo() + " ha esquivado "+esquivados+"\n\n";
						}
						else {
			...
			if (C01_Principal.pokemon.get(C09_Combate.turno).getMisilesRonda()<=0 && C09_Combate.turno < (C01_Principal.pokemon.size()-1) && checkbox) {
				...
				if (C01_Principal.pokemon.get(C09_Combate.turno).getTipoPlaneta()==5) {
					...
					C01_Principal.pokemon.get(C09_Combate.turno).setMisilesRonda(10*C09_Combate.contRonda);
	...
	public static void tipoFondoPokemon (int tipo, JLabel jlFondo) {
		...
		if (C01_Principal.pokemon.get(C09_Combate.turno).getTipoPlaneta() == 1) {
			...
			if(C01_Principal.pokemon.size()== 8) {
				...
				jlFondo.setIcon(new ImageIcon("src/resources/fondos/FondosCombate/normal/combate_1pb.png"));
			}
			...
			if(C01_Principal.pokemon.size()== 8) {
				...
				jlFondo.setIcon(new ImageIcon("src/resources/fondos/FondosCombate/fuego/combate_1pb.png"));
			...
			if(C01_Principal.pokemon.size()== 8) {
				...
				jlFondo.setIcon(new ImageIcon("src/resources/fondos/FondosCombate/agua/combate_1pb.png"));
			}
			...
			if(C01_Principal.pokemon.size()== 8) {
				...
				jlFondo.setIcon(new ImageIcon("src/resources/fondos/FondosCombate/planta/combate_1pb.png"));
			}
			...
			if(C01_Principal.pokemon.size()== 8) {
				...
				jlFondo.setIcon(new ImageIcon("src/resources/fondos/FondosCombate/dragon/combate_1pb.png"));
			}
			...
			if(C01_Principal.pokemon.size()== 8) {
				...
				jlFondo.setIcon(new ImageIcon("src/resources/fondos/FondosCombate/bicho/combate_1pb.png"));
			}
